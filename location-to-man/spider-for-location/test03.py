...
while (n<3000):
    ...
    #获取正则匹配到的结果，返回list
    s = p.findall(html)
    if os.path.isdir("E://ShuJiaPeiXun//708Spider//test_pic") !=True:
        os.makedirs("E://ShuJiaPeiXun//708Spider//test_pic")
    with open("testpic.txt","a") as f:
        ...
        for i in s:
            ...
            f.write("\n")
            #保存图片
            urllib.request.urlretrieve(i,"E://ShuJiaPeiXun//708Spider//test_pic//pic{num}.jpg".format(num=j))
            j+=1
        f.close()
